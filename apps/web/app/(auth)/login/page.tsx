...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-[400px]">
      {/* GitHub OAuth first — highest conversion */}
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-xs uppercase">
          <span className="bg-[#fafafa] px-3 text-foreground/40">or sign in with email</span>
        </div>
      </div>
      ...
      <div className="rounded-2xl border border-foreground/10 bg-white p-6 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end"><a href="#" className="text-xs font-medium text-violet-600 hover:text-violet-700">Forgot password?</a></div>
